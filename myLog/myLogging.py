...
default_formats = {
    # 终端输出格式
    'color_format': '%(log_color)s[%(asctime)s]-%(name)s-[line:%(lineno)d]-[%(levelname)s]: %(message)s',
    # 日志输出格式
...
class MyLogger:
    ...
    def __init__(self, log_path=None, time_type='hh'):
        ...
        self.__error_log_path = os.path.join(err_path, self.__now_time + "-error" + ".log")  # 收集错误日志信息文件
